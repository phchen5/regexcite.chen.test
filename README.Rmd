...
The goal of regexcite.chen.test is to make regular expressions more exciting! It provides convenience functions to make some common tasks with string manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexcite.chen.test from [GitHub](https://github.com/phchen5/regexcite.chen.test) with:
